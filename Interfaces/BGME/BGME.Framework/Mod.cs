...
public class Mod : ModBase
{
    ...
    private void OnBgmeModLoading(BgmeMod mod)
    {
        if (this.game == Game.P5R_PC)
        {
            ...
            {
                this.ryo.AddAudioPath(bgmeAudioDir_P5R, new() { AcbName = "bgm", CategoryIds = [1, 8] });
            }
        }
        else if (this.game == Game.P4G_PC)
        {
            ...
            if (Directory.Exists(femuAwbDir_P4G))
            {
                foreach (var file in Directory.EnumerateFiles(femuAwbDir_P4G, "*.hca"))
                {
                    ...
                    {
                        this.ryo.AddAudioPath(file, new() { AcbName = "snd00_bgm", CategoryIds = [6, 13] });
                    }
                }
            }
            ...
            {
                this.ryo.AddAudioPath(bgmeAudioDir_P4G, new() { AcbName = "snd00_bgm", CategoryIds = [6, 13] });
            }
        }
        ...
        else if (this.game == Game.Metaphor)
        {
            ...
            {
                this.ryo.AddAudioPath(bgmeAudioDir_Meta, new() { AcbName = "bgm", CategoryIds = [0, 9, 12] });
            }
        }
